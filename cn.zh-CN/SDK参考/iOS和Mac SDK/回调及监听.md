...
|[onCaptureVideoSample](#li_pnq_s1e_3zp)|订阅的本地采集视频数据回调（仅Mac）|1.16.2|
|[onRemoteVideoSample](#li_ulk_tgq_zyy)|订阅的远端视频数据回调（仅Mac）|1.16.2|
...
|[onAudioVolumeCallback](#li_tuj_w6c_522)|用户音量大小回调|1.17.9|
