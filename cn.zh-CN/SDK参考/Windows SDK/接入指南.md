...
![App SDK交互图](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170941/156714642347688_zh-CN.png)
...
2.  使用Visual Studio创建一个MFC Dialog based类型的工程，工程命名为RTCSample。
    ...
    **说明：** 本文以MFC的工程为例，您也可以选择其他UI框架。
    ...
    ![创建工程](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642349362_zh-CN.png)

    ![创建工程](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642349363_zh-CN.png)

3.  将RTC EngineSDK的相关文件移动到.sln文件所在的目录。

    ![拷贝SDK](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642349364_zh-CN.png)
...
5.  设置32位工程属性。
    ...
    ![设置工程属性](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642449365_zh-CN.png)

6.  在工程属性页面，设置依赖头文件的路径。

    ![设置依赖](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642449369_zh-CN.png)

7.  设置静态库的路径。

    ![静态库](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642449370_zh-CN.png)

8.  复制AliRTCSdk.dll及依赖的ffmpeg.dll到程序的执行路径下。

    ![复制依赖](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/170923/156714642449371_zh-CN.png)
