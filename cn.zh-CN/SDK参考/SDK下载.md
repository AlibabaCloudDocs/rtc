...
|Windows|[Windows](/cn.zh-CN/快速入门/集成客户端SDK/Windows.md)|[Windows接口说明](/cn.zh-CN/SDK参考/1.17版本/Windows SDK/AliRtcEngine接口.md)|x86版本：
...
|Mac|[Mac](/cn.zh-CN/快速入门/集成客户端SDK/Mac.md)|[Mac接口说明](/cn.zh-CN/SDK参考/1.17版本/iOS和Mac SDK/AliRtcEngine接口.md)|[V2.1](https://alivc-demo-cms.alicdn.com/versionProduct/sourceCode/rtc/2.1/AliRTCSdk_2.1(Mac).zip)|[Mac示例代码](https://github.com/aliyunvideo/AliRtcAppSample_Mac)|
