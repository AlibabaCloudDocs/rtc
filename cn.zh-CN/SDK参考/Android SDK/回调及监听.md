...
|[onAliRtcLocalVideoStats](#li_g9s_hrd_3n8)|本地视频统计信息回调|1.17|
|[onAliRtcRemoteVideoStats](#li_dyl_gwj_mi4)|远端视频统计信息回调|1.17|
...
|API|描述|以上版本支持|
|---|--|------|
|[onRemoteUserUnPublish](#li_el2_mzw_xje)|当远端用户停止发布时回调|1.1|
