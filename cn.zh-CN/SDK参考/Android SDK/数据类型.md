...
|[AliRtcAudioPlayingType](#li_i97_kyl_ddy)|音乐伴奏播放状态|1.16.2|
...
-   AliVideoCanvas：渲染画布。
    ...
    |[AliRtcRenderMode](#li_0yg_y0d_1wv)|渲染模式|
    |[AliRtcRenderMirrorMode](#li_0yn_ljb_bs7)|镜像模式|
...
-   AliRtcRecordAudioConfig：录制音频设置。
    ...
    |枚举名|描述|
    |---|--|
    |[AliRtcAudioSampleRate](#li_pm7_fif_g5x)|录制音频文件采样率|
    |[AliRtcAudioQuality](#li_haa_a7c_1de)|录制音频文件质量|
