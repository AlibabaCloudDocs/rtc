...
-   您已经开通RTC服务，具体操作，请参见[开通服务](/cn.zh-CN/快速入门/开通服务.md)。
-   您已经创建好应用，具体操作，请参见[创建应用](/cn.zh-CN/快速入门/创建应用.md)。
-   您已经获取AppKey，具体操作，请参见[查询AppKey](/cn.zh-CN/控制台指南/查询AppKey.md)
...
|Token|加入频道的Token，由AppServer生成。实际算法为`sha256(appId + appKey + channelId + userId + nonce + timestamp)`。|
...
-   Golang程序实例请查看`CreateToken`函数，更多信息，请参见[Golang Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/golang/main.go)。
-   Java程序实例请查看`createToken`函数，更多信息，请参见[Java Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/java/src/main/java/com/company/App.java)。
-   Python程序实例请查看`create_token`函数，更多信息，请参见[Python Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/python/server.py)。
-   C\#程序实例请查看`CreateToken`函数，更多信息，请参见[C\# Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/csharp/rtc-app-csharp/Program.cs)。
-   Nodejs程序实例请查看`CreateToken`函数，更多信息，请参见[Node.js Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/nodejs/index.js)。
-   PHP程序实例请参查看`CreateToken`函数，更多信息，请参见[PHP Demo](https://github.com/aliyunvideo/AliRtcAppServer/blob/master/php/app/v1/login.php)。
